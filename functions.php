...
function tambah($data)
{
	...
	$query = "INSERT INTO mhs_aryarizky VALUES ('','$nim_mhs','$nama_mhs','$tahun_ajaran','$jurusan','$no_hp','$jenis_kelamin','$tgl_lahir','$alamat','$gambar')";
...
{
	global $conn;
	mysqli_query($conn, "DELETE FROM mhs_aryarizky WHERE id_mhs = $id_mhs");
	return mysqli_affected_rows($conn);
}
function ubah($data)
{
	...
	$query = "UPDATE mhs_aryarizky SET 
	nim_mhs = '$nim_mhs',
	nama_mhs = '$nama_mhs',
